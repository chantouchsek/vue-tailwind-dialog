<template>
  <div class="flex justify-between bg-white rounded overflow-hidden p-2 space-x-1"
  >
    ...
    <div class="flex flex-grow items-center">
      <p class="leading-tight text-xs md:text-sm" v-html="text" />
    </div>
    <div>
      <button
          type="button"
...
export default {
  layout: ['default', { hideBackdrop: true }],
  mixins: [ Confirmable ],
  props: {
    variant: String,
    timeout: {
